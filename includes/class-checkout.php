...
if( !class_exists( 'Aurpay_Payment_Gateway' ) ):
    class Aurpay_Payment_Gateway extends WC_Payment_Gateway
    {
        ...
        /**
         * Aurpay_Payment_Gateway constructor.
         * @since 1.0
         * @version 1.0.0
         */
        ...
        public function process_payment($order_id)
        {
            ...
            if ($response_code==200 && $resp_data->code == 0) {
                ...
                if ($resp_data->code = 401) {
                    wc_add_notice( sprintf( 'Aurpay payment notify Error: %s', 'Please fill in the aurpay public key in admin'), 'error' );
                }
                else {
